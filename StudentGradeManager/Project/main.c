/*==========================================================================================
 *		MAIN SOURCE FILE: Entry point for the Student Grade Manager program.
...
int main(void) 
{
	...
	db_init(&db);
	menu_printHeader();																			// function call to display the header
	printf(" Welcome to Student grade manager! Use the menu below To manage the students.\n");	// message to be printed after haeader
	int running = 1;																			// variable set to continue the loop until the user wants to quit
	while (running) 
	{
		int choice = menu_showMain();															// shows the functions this code can perform, and takes entry from the user
		switch (choice)
		{
		case 1:
